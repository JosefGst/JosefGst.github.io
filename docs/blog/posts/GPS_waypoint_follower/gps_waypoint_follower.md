...
I used the flight [controller](https://docs.px4.io/main/en/flight_controller/pixhawk4.html) from my crashed drone and put it on the rc-car won from the [autonomous rc-car race](../autonomous_rc-car_race.md). And boom I got an autonomous rover that can follow gps coordinates set up in [Ardupilot](https://ardupilot.org/ardupilot/index.html) as the mission planner.
