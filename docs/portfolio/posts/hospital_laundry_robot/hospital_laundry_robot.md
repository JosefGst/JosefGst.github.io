...
# 🏥 TKO Hospital Laundry Robot: Engineering Autonomy in Real-World Chaos
...
- 🚶‍♂️ **Narrow, busy corridors:** Hospital hallways are crowded with people, trolleys, and equipment. The robot’s large footprint made navigation especially tricky. Additionally, the robot should not move in the middle of the hallway to avoid blocking the way for people or patient beds.
...
- 🗺️ **SLAM and Navigation:** I set (SLAM) and tuned the navigation until the robot could navigate in very narrow hallways, moved close to the wall without getting stuck or colliding.
