...
## My Contributions
- Setting up SLAM, navigation, and coverage path planning for an autonomous water tank cleaning robot using ROS2 and the Gazebo simulation environment.
...
- Successfully demonstrated autonomous cleaning in both simulation and real-world tank environments.
- Achieved full coverage of tank surfaces with reliable navigation and obstacle avoidance.
- Reduced manual labor and improved safety by minimizing human entry into confined spaces.
- The modular Docker environment accelerated development and testing cycles.
